...
class ProductItem extends StatelessWidget {
  ...
  const ProductItem({Key? key, required this.width, this.productData})
      : super(key: key);
          ...
          Column(
            ...
            children: [
              ...
              Expanded(
                  flex: 2,
                  child:
                      Container()), // This is the grey space above the Card where the food appears to be on top of card
              Expanded(
                flex: 7,
                child: Container(
